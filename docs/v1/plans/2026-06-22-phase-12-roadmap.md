...
| 12.9 | Architecture spikes (msgpack IPC / FAISS / PyO3 / Nuitka) — research — **✅ done; all defer/reject, 0 adopts** (`docs/optimization/architecture-spike-findings.md`) | Velocity | `…-phase-12-9-architecture-spikes.md` |
| 12.9.1–x | Conditional architecture *implementation* (speculative) — **all VOID** (no 12.9 adopt) | Velocity | `…-phase-12-9-implementation-speculative.md` |
